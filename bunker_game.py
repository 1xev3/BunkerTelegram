...
class GameData:
    ...
    SPECIAL_ABILITIES = [
        "Может исцелить одного игрока от любой болезни",
        "Может увидеть одну скрытую характеристику другого игрока",
        "Может защитить одного игрока от исключения в следующем раунде",
